...
$sheet->setCellValue('AI1', 'Keluhan ke Pemerintah');
$sheet->setCellValue('AJ1', 'Catatan Tambahan');
...
while ($row = mysqli_fetch_array($query)) {
    ...
    $sheet->setCellValue('AI' . $i, $row['keluhan_ke_pemerintah']);
    $sheet->setCellValue('AJ' . $i, $row['catatan_tambahan']);
