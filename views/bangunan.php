...
<body class=" bg-secondary">
    <div class="jumbotron bg-dark text-light text-center">
        ...
        <p class="lead">Export Import Tabel Bangunan</p>
        <hr class="my-1">
        ...
        <div class="row">
            ...
            <div class="card col-md-6 mr-1 mb-1">
                <div class="card-body">
                    ...
                    <form method="post" enctype="multipart/form-data" action="../proses/import_bangunan.php">
            ...
            <div class="card col mr-1 mb-1">
                <div class="card-body">
                    ...
                    <p>File hasil export = htdocs/Data Export/<strong>Data Bangunan.xlsx</strong></p>
                    ...
                    <p></p>
                    <a class="btn btn-success" href="../proses/export_bangunan.php">Export</a>
                </div>
            </div>
